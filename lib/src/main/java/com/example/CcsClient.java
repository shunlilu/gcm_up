...
public class CcsClient {
    ...
    private String mApiKey = "AIzaSyCORU3-ib4_9cSCKAzTs3Ecj4l-N9QwKf0";
    ...
    private CcsClient(String projectId, String apiKey, boolean debuggable) {
        this();
        mApiKey = "AIzaSyCORU3-ib4_9cSCKAzTs3Ecj4l-N9QwKf0";
    ...
    public static void main(String[] args) {
        final String projectId = "294253090782";
        ...
        final String toRegId ="APA91bHn-7BYCisXzaPO9Aene8vzwvGkAIhBGQWg4kWVg7gATAcs2M2sIPk-8UW7gpi1B9LcUrZJzfmk_-cezZeD71cihp4ccxdoPCZZv5NAfXjabMvIYiJxgQYSQ8qKAYfz8hpnuIdA";
